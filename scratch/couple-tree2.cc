...
int main (int argc, char *argv[]){
  ...
  dqc::CoupleManager *manager=dqc::CoupleManager::Instance();
	...
	InstallDqc(kRenoBytes,c.Get(1),c.Get(2),sendPort,recvPort,appStart,appStop,nullptr,max_bps,0);
	sendPort++;
	recvPort++;
	...
	InstallDqc(kRenoBytes,c.Get(7),c.Get(8),sendPort,recvPort,appStart,appStop,nullptr,max_bps,0);
	sendPort++;
	recvPort++;
